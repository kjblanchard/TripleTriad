...
- `package.json` manifest `author` section changed to be consistent with my other products. (Unity Package Manager group assets under the same `author` in the same dropdown.)
